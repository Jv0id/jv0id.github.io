	...
	<bean id="sessionFactory" class="org.springframework.orm.hibernate4.LocalSessionFactoryBean">
		...
		<property name="hibernateProperties">
			<props>
				...
				<prop key="hibernate.hbm2ddl.auto">upmodify_date</prop>
			</props>
		</property>
...
<hibernate-configuration>
    <session-factory>
		...
		<property name="hibernate.hbm2ddl.auto">upmodify_date</property>
...
public interface BookShopDao {
	...
	//更新数的库存. 使书号对应的库存 - 1
	public void upmodify_dateBookStock(String isbn);
	
	//更新用户的账户余额: 使 username 的 balance - price
	public void upmodify_dateUserAccount(String username, int price);
}
...
//	private HibernateTemplate hibernateTemplate;
	...
	public void upmodify_dateBookStock(String isbn) {
		...
		getSession().createQuery(hql).setString(0, isbn).executeUpmodify_date();
	}
	...
	public void upmodify_dateUserAccount(String username, int price) {
		...
		getSession().createQuery(hql).setInteger(0, price).setString(1, username).executeUpmodify_date();
	}
...
public class BookShopServiceImpl implements BookShopService {
	...
	public void purchase(String username, String isbn) {
		...
		bookShopDao.upmodify_dateBookStock(isbn);
		bookShopDao.upmodify_dateUserAccount(username, price);
	}
